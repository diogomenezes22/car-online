...
$tinybrowser['path']['image'] = '/sindirepa/img/upload/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/sindirepa/img/upload/'; // Media files location
$tinybrowser['path']['file']  = '/sindirepa/img/upload/'; // Other files location
