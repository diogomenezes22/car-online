	...
	function init_wysiwyg() {
		...
		$('textarea.wysiwyg-editor').each(function(){
			...
			new nicEditor({iconsPath : 'scripts/nicEdit/nicEditorIcons.gif'}).panelInstance(editor_id); 
	...
	$(document).ready(function(){
		$("#comparar-senha").click(function(){
			if($("#senha").val() == $("#confirmar-senha").val()){
				return true;
			}else{
				$("#senha").css("border-color","red");
				$("#confirmar-senha").css("border-color","red");				
				$("#msg-error").html("Confirmação de senha inválida.");
				return false;
			}
		});	
	});